...
CLASS_LABELS = {
    ...
    "muoncollider": [0, 211, 130, 22, 11, 13],
}
...
CLASS_NAMES_CAPITALIZED = {
    ...
    "muoncollider": ["none", "Charged hadron", "Neutral hadron", "Photon", "Electron", "Muon"],
}
